/* INIQ — Notícias: shared data source.
   NOTE: backend-ready — replace this array with a fetch() to the news API.
   Both noticias.html (listagem) and noticia.html (artigo) consume window.NEWS. */
window.NEWS = [
  {
    id: 1, slug: 'consulta-publica-12-projectos-norma',
    titulo: 'INIQ abre consulta pública de 12 novos projectos de norma',
    cat: 'Normalização', data: '2026-06-02', img: 'assets/cover-normalizacao.jpg',
  ...
  {
    id: 2, slug: 'metrologia-reforca-calibracao',
    titulo: 'Laboratório Nacional de Metrologia reforça capacidade de calibração',
    cat: 'Metrologia', data: '2026-05-28', img: 'assets/cover-metrologia.jpg',
  ...
  {
    id: 3, slug: 'forum-iniq-cplp-luanda',
    titulo: 'Angola acolhe reunião do Fórum das IE da Qualidade da CPLP',
    cat: 'CPLP', data: '2026-05-19', img: 'assets/cover-cplp.jpg',
  ...
  {
    id: 4, slug: 'premio-nacional-qualidade-2026',
    titulo: 'Prémio Nacional da Qualidade 2026 abre candidaturas',
    cat: 'Qualidade', data: '2026-05-12', img: 'assets/cover-qualidade.jpg',
  ...
  {
    id: 5, slug: 'rotulagem-produtos-alimentares',
    titulo: 'Novas regras de rotulagem de produtos alimentares em discussão',
    cat: 'Normalização', data: '2026-05-05', img: 'assets/cover-seguranca.jpg',
  ...
  {
    id: 6, slug: 'formacao-120-auditores',
    titulo: 'INIQ forma 120 auditores internos da qualidade',
    cat: 'Formação', data: '2026-04-27', img: 'assets/cover-qualidade.jpg',
  ...
  {
    id: 7, slug: 'protocolo-institutos-cplp',
    titulo: 'INIQ assina protocolo de cooperação com institutos da CPLP',
    cat: 'CPLP', data: '2026-04-15', img: 'assets/cover-cplp.jpg',
  ...
  {
    id: 8, slug: 'jornada-portas-abertas',
    titulo: 'Sede do INIQ recebe jornada de portas abertas',
    cat: 'Qualidade', data: '2026-04-03', img: 'assets/cover-sede.jpg',
