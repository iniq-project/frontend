...
watch(
  ...
  (isOpen) => {
    if (isOpen) {
      formData.value = { entidade: "", telefone: "", email: "", comentario: "" }
...
<template>
  <div v-if="open" class="modal" :class="{ open }" @click.self="handleClose">
    ...
    <div class="modal-panel" role="dialog" aria-modal="true" aria-labelledby="arcrtCommentModalTitle">
      <div class="modal-head">
        <div>
          <span class="eyebrow">Consulta Pública</span>
          <h3 id="arcrtCommentModalTitle">Contribuir</h3>
      ...
      <div class="modal-body">
        <div v-if="!formSubmitted" class="form-wrap">
          <form @submit.prevent="handleSubmit">
            <div class="field">
              <label for="rc-entidade">Entidade <span class="req">*</span></label>
              <input
                type="text"
                id="rc-entidade"
                name="entidade"
            ...
            <div class="field">
              <label for="rc-telefone">Número de Telefone <span class="req">*</span></label>
              <input
                type="tel"
                id="rc-telefone"
                name="telefone"
            ...
            <div class="field">
              <label for="rc-email">E-mail <span class="req">*</span></label>
              <input
                type="email"
                id="rc-email"
                name="email"
            ...
            <div class="field">
              <label for="rc-comentario">Comentário, sugestão ou observação <span class="req">*</span></label>
              <textarea
                id="rc-comentario"
                name="comentario"
            ...
            <div class="field">
              <label for="rc-anexo">Anexar documento (opcional)</label>
              <div class="file-input-wrapper">
                <input type="file" id="rc-anexo" name="anexo" @change="handleFileChange" />
