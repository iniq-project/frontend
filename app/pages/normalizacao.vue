        ...
        <div v-if="!formSubmitted" class="form-wrap" id="formWrap">
          <form @submit.prevent="handleSubmit">
            <div class="field">
              ...
              />
              <span v-if="errors.nomeEntidade" class="error-text"
                >Por favor, informe o nome da entidade</span
              >
            </div>
            <div class="field">
              ...
              />
              <span v-if="errors.nif" class="error-text"
                >Por favor, informe o NIF</span
              >
            </div>
            <div class="field">
            ...
            <div class="field">
              <label for="f-tel"
                >Número de Telefone <span class="req">*</span></label
              >
              <input
                type="tel"
                id="f-tel"
              ...
              />
              <span v-if="errors.telefone" class="error-text"
                >Por favor, informe o número de telefone</span
              >
            </div>
